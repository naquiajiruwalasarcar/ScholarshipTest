...
{
	/** database url */
	private String url = "jdbc:mysql://scholarship-test.c9sffuysowjo.ap-southeast-1.rds.amazonaws.com:3306/zenith_master?useSSL=false&createDatabaseIfNotExist=TRUE";
	/** database username */
	...
	private int m_maxLifetime = 60000;
	/**
	 * The name for the master database connection pool
	 */
	private String poolName = "masterdb-connection-pool";
	@Override
	...
	public int getM_maxLifetime() 
	{
		return m_maxLifetime;
	}
	
	public void setM_maxLifetime(int m_maxLifetime) 
	{
		this.m_maxLifetime = m_maxLifetime;
	}
}